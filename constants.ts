...
export const CLIENT_CONFIG = {
  ...
  storageKey: 'workout_app_damian_v1' 
};
...
export const DEFAULT_WORKOUTS: WorkoutsMap = {
  "gora": {
      ...
      exercises: [
          ...
          { id: "g_4", name: "Single Arm Row", pl: "Wiosłowanie hantlem jednorącz", sets: 3, reps: "9-12", tempo: "2111", rir: "2/2/1", rest: 120, link: "https://www.youtube.com/shorts/kt7iBID_FPA", type: "standard" },
          ...
          { id: "g_6", name: "Spider Curl", pl: "Uginanie ramion (Spider)", sets: 3, reps: "9-12", tempo: "2111", rir: "2/2/1", rest: 120, link: "https://www.youtube.com/shorts/ivS3G35bapw", type: "standard" },
  ...
  "dol": {
      ...
      exercises: [
          { id: "d_1", name: "Split Squat", pl: "Przysiad wykroczny", sets: 3, reps: "6-9", tempo: "2011", rir: "2/2/1", rest:120, link: "https://www.youtube.com/watch?v=hXpGSa5HYqY", type: "standard" },
          ...
          { id: "d_3", name: "Leg Adduction", pl: "Przywodzenie (maszyna)", sets: 3, reps: "9-12", tempo: "2111", rir: "2/1/1", rest: 120, link: "https://www.youtube.com/watch?v=EHq78mQYLbI", type: "standard" },
          { id: "d_4", name: "Leg Extension", pl: "Wyprosty nóg (maszyna)", sets: 3, reps: "10-15", tempo: "2011", rir: "1", rest: 90, link: "https://www.youtube.com/shorts/iQ92TuvBqRo", type: "standard" },
          ...
          { id: "d_6", name: "Calf Raises", pl: "Wspięcia na palce", sets: 3, reps: "9-12", tempo: "2111", rir: "2/1/0", rest: 120, link: "https://www.youtube.com/shorts/wlqTemUXPXY", type: "standard" },
  ...
  "fbw": {
      ...
      warmup: [
          ...
          { name: "SingleL Glute Bridge", pl: "Mostek jednonóż", link: "https://www.youtube.com/shorts/qB_bC7-CQjI", reps: "10p" },
          { name: "Air Split Squat", pl: "Przysiad wykroczny (bez obciążenia)", link: "", reps: "10p" }
      ],
      exercises: [
          ...
          { id: "f_3", name: "Cable Horizontal Row", pl: "Wiosłowanie linką (poziomo)", sets: 3, reps: "8-11", tempo: "2111", rir: "2/2/1", rest: 120, link: "https://www.youtube.com/shorts/T__GM6KXJqQ", type: "standard" },
          { id: "f_4", name: "Leg Curl Lying", pl: "Uginanie nóg leżąc (maszyna)", sets: 3, reps: "9-12", tempo: "2011", rir: "2/1/1", rest: 90, link: "https://www.youtube.com/shorts/FMCq0hT3KRU", type: "standard" },
          ...
          { id: "f_8", name: "Allahy", pl: "Skłony na wyciągu (klęcząc)", sets: 3, reps: "9-12", tempo: "2111", rir: "2/1/0", rest: 120, link: "https://www.youtube.com/watch?v=6KlUGwZxdRE", type: "standard" }
      ]
  }
};